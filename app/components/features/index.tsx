...
export function SquaresPlusIcon() {
  return (
    <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className='h-10 w-10 text-darkBlue'>
    ...
    <div className="bg-grayT py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-3xl text-center font-bold tracking-tight text-normalBlue sm:text-4xl">The future is headless</h2>
          <p className="mt-6 text-lg text-center leading-8 text-darkBlue">
          A way to future-proof your ecommerce business and ensure that your business can adapt to changing market conditions and customer expectations.
          </p>
        </div>
            ...
            {features.map((feature) => (
              <div key={feature.name} className="flex flex-col">
                ...
                <dd className="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-900">
                  ...
                  <p className="mt-6">
                    <a href={feature.href} className="text-sm font-semibold leading-6 text-lightBlue hover:text-yellowT">
